...
namespace Francis.Telegram.Answers.CallbackAnswers
{
    public class ConfirmLogoutAnswer : TelegramAnswer
    {
        ...
        {
            Context.Database.RemoveRange(Context.Database.Progressions.Where(x => x.BotUserId == Context.User.Id));
            Context.Database.RemoveRange(Context.Database.WatchedItems.Where(x => x.BotUserId == Context.User.Id));
